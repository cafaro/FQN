...
#####################################################################
#
# This script executes the Nunkesser algorithm with limited buffer B
# cycling through all the distributions...
#
#####################################################################
#

echo "Starting tests for Nunkesser algorithm with limited buffer B ..."
echo
    ...
    FILES=./BenchPDF/*.csv
        ...
        for f in $FILES; do
            ...
            do
                ...
                echo "./nunkesser_limitedB $f ${Ncount} $K"
                ./nunkesser_limitedB $f ${Ncount} $K > /dev/null 2>> ${LOGDIR}NunkesserLog.csv
                echo
            done #for r
